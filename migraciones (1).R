...
puntos = st_read("D:/Proy.gbif/gbif/Arboles_exoticos/data_e.shp")
names(base)

length(unique(p1$scientific))
p1 = subset(puntos, country_su == "Venezuela")
...
ggplot(base ,aes(NAME_0 , exotica, color = NAME_0 )) + 
  geom_boxplot()+
  #scale_y_continuous(limits = c(0,0.5))+
  xlab("Country")+ ylab("Exotic trees abundance")+
  guides(colour=guide_legend(override.aes=list(alpha=1, size=3)))+
